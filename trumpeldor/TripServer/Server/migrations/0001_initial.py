    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attractionsDone', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('nextAttraction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Server.Attraction')),
