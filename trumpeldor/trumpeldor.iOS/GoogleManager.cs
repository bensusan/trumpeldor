...
namespace trumpeldor.iOS
{
    ...
    {
        private Action<trumpeldor.Models.GoogleUser, string> _onLoginComplete;
        ...
        public void Login(Action<trumpeldor.Models.GoogleUser, string> OnLoginComplete)
        {
        ...
        public void DidSignIn(SignIn signIn, Google.SignIn.GoogleUser user, NSError error)
        {
            ...
            if (user != null && error == null)
                _onLoginComplete?.Invoke(new trumpeldor.Models.GoogleUser()
                {
                    ID = user.UserID,
