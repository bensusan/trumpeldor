...
{
    public class ServerConnectionImpl : ServerConection
    {
        private static ServerConnectionImpl instance = null;
        ...
        public static ServerConnectionImpl getInstance()
        {
            if (instance == null)
            {
                using (var cts = new CancellationTokenSource())
                {
                    ...
                    PORT = config.PORT;
                    DEBUG = config.DEBUG;
                    URL_MEDIA = "http://" + ServerConnectionImpl.IP + ":" + ServerConnectionImpl.PORT + "/media/";
                }
                instance = new ServerConnectionImpl();
            }
            return instance;
        }
        ...
        public Track GetExtendedTrack(Track track, SheredClasses.Point userLocation)
        {
